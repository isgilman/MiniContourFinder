...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
def process_image(image_path, neighborhood=10, prefix=None, Amin=50, Amax=10e6,
    ...
    **kwargs : kwargs for `mcf`
    ...
    if print_plots:
        ...
        render_contour_plots(image=image, border_contour=border_contour, contours=contours, prefix=prefix, dpi=dpi, output_dir=output_dir)
